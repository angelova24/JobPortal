...
namespace JobPortal.Data.Migrations
{
    ...
    [Migration("20230805202006_AddArticles")]
            ...
            modelBuilder.Entity("JobPortal.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bd5e410c-c7b6-44db-b7e2-47ed240a94c8",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELfzO0j8mQnxGh+pw0WJThh09FSzfX4+2p3bky+KCLRKw0CiHPI8OXxaUeq97epODg==",
            ...
            modelBuilder.Entity("JobPortal.Data.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5c68d020-8550-4796-8143-61ae85e2c938"),
                            AuthorId = new Guid("e30fae8e-5a56-4112-9250-aff3affb75a4"),
                            CreatedOn = new DateTime(2023, 8, 5, 22, 20, 5, 816, DateTimeKind.Local).AddTicks(8340),
                        ...
                        new
                        {
                            Id = new Guid("8685a8a5-30e3-49b3-a082-0d8a3ac6e03d"),
                            AuthorId = new Guid("e30fae8e-5a56-4112-9250-aff3affb75a4"),
                            CreatedOn = new DateTime(2023, 8, 5, 22, 20, 5, 816, DateTimeKind.Local).AddTicks(8400),
            ...
            modelBuilder.Entity("JobPortal.Data.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("80ae0ab5-523e-4596-ab65-3b7e3bd0845e"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 8, 5, 22, 20, 5, 816, DateTimeKind.Local).AddTicks(9770),
                        ...
                        new
                        {
                            Id = new Guid("2f2dfc53-0d6b-4c60-b896-f46ed185a5e6"),
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 8, 5, 22, 20, 5, 816, DateTimeKind.Local).AddTicks(9790),
                        ...
                        new
                        {
                            Id = new Guid("dec52b5c-aa9d-4a45-86e9-1ec870817237"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 5, 22, 20, 5, 816, DateTimeKind.Local).AddTicks(9810),
