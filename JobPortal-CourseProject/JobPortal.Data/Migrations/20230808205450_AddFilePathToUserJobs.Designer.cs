...
namespace JobPortal.Data.Migrations
{
    ...
    [Migration("20230808205450_AddFilePathToUserJobs")]
    partial class AddFilePathToUserJobs
    {
            ...
            modelBuilder.Entity("JobPortal.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "48adbc84-300e-4ea2-becd-d4f62a9d481e",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIArVEuirNA4aZ5mG3puZGCv+FnFQzQMvtOzF4w0ZOI+Nmiz+k3rwEzNUfwiQ5sPcA==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f09bf2cc-46f3-419e-a304-2ffe2e1a6d72",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEMJGQF5AFP9eNxhKzjpz77Ss3y2huAxE8KwrJwz9k1ABGdldZ5+bHpD2XjrlwmC/yQ==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("JobPortal.Data.Models.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4c2dbdd7-b9e5-4b4a-acb7-77dc7091ac7b"),
                            AuthorId = new Guid("e30fae8e-5a56-4112-9250-aff3affb75a4"),
                            CreatedOn = new DateTime(2023, 8, 8, 22, 54, 50, 582, DateTimeKind.Local).AddTicks(4850),
                        ...
                        new
                        {
                            Id = new Guid("042bf5e2-3589-40da-aa3d-6d537632f63a"),
                            AuthorId = new Guid("e30fae8e-5a56-4112-9250-aff3affb75a4"),
                            CreatedOn = new DateTime(2023, 8, 8, 22, 54, 50, 582, DateTimeKind.Local).AddTicks(4920),
            ...
            modelBuilder.Entity("JobPortal.Data.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4d5995f8-2b15-4133-aacb-0fbab252abf7"),
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 8, 8, 22, 54, 50, 582, DateTimeKind.Local).AddTicks(6290),
                        ...
                        new
                        {
                            Id = new Guid("e9c268c1-a356-4655-8fc1-18e156b7d3b4"),
                            CategoryId = 4,
                            CreatedOn = new DateTime(2023, 8, 8, 22, 54, 50, 582, DateTimeKind.Local).AddTicks(6310),
                        ...
                        new
                        {
                            Id = new Guid("dbf6e000-cfe9-45ae-b17f-63010b26d9aa"),
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 8, 8, 22, 54, 50, 582, DateTimeKind.Local).AddTicks(6320),
